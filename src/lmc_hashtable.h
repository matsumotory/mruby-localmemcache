...
#define LMC_ITERATOR_P(n) int((n))(void *ctx, const char *key, const char *value)
...
int ht_hash_iterate(void *base, va_ht_hash_t ht, void *ctx, ht_iter_status_t *s, LMC_ITERATOR_P(iter));
